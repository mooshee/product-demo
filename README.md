...
Product Demo automates capture and motion polish. It is not a clone or full replacement for Screen Studio’s desktop editor.
...
```bash
git clone https://github.com/mooshee/product-demo.git \
  "$HOME/.agents/skills/product-demo"
```
...
Explore the [Moosh Works Open Skills catalog](https://mooshworks.com/skills/) or try [ChatGPT Search Query Mining](https://github.com/mooshee/chatgpt-search-query-mining), an experimental skill for turning a controlled ChatGPT query cluster into a source-backed content plan.
